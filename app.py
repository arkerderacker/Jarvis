...
def _parse_natural_schedule(text):
    ...
    if not date_part:date_part=_now_sgt().strftime('%Y-%m-%d')
...
.v10-badge{display:inline-flex;align-items:center;gap:5px;font-size:9px;letter-spacing:.12em;color:var(--muted);padding:4px 7px;border:1px solid var(--border);border-radius:999px}.action-step{display:flex;gap:7px;align-items:center;padding:4px 0}.action-step.done{color:var(--accent)}.diag-row{display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid var(--border);font-size:11px}.diag-ok{color:var(--accent)}.diag-bad{color:#ff6b6b}.automation-item{padding:8px;border:1px solid var(--border);border-radius:10px;margin:5px 0}.automation-item button{float:right}.msg-actions{min-height:18px}.usage-panel{max-height:75vh;overflow:auto}
</style></head><body>
