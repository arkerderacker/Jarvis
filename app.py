...
@media(max-width:800px){#jarvisActivity{width:230px;right:10px;top:58px}#jarvisVisualCore{width:min(68vw,360px)}#jarvisTools{bottom:64px}.jiMenu{max-width:95vw;overflow:auto}}
</style></head><body>
<div id="scene"></div><div id="top"><div class="brand"><i></i>JARVIS</div><div class="status" id="status">INITIALIZING</div></div><div class="tip" id="tip"></div><video id="handcam" playsinline></video><div id="pointer"></div>
...
async function sendSilent(text){
 ...
 try{
  ...
  if(d.reply){addMsg('j',d.reply);await speak(d.reply);rebuildWords(text+' '+d.reply);if(listening===false)showVoiceStatus('ONLINE')}
...
<div id="jarvisVisualCore" aria-hidden="true"><div class="jring"></div><div class="jring"></div><div class="jring"></div><div id="jarvisWave"></div><div class="jenergy"></div></div>
