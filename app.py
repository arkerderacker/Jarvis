...
(()=>{
 ...
 function fingerCurled(h,tip,pip){return dist(h[tip],h[0])<dist(h[pip],h[0])*1.10}
 function fingerExtended(h,tip,pip,mcp){return dist(h[tip],h[mcp])>dist(h[pip],h[mcp])*1.12}
 function isFist(h){return fingerCurled(h,8,6)&&fingerCurled(h,12,10)&&fingerCurled(h,16,14)&&fingerCurled(h,20,18)}
 function isPointing(h){return fingerExtended(h,8,6,5)&&fingerCurled(h,12,10)&&fingerCurled(h,16,14)&&fingerCurled(h,20,18)}
