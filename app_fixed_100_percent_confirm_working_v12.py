...
def handle_command(text):
    ...
    if re.search(r"\b(find|search|look up|show me)\b.*\b(image|picture|photo|pic)\b",lower):
        ...
        return "I found these images.",{"type":"image_search","query":query}
